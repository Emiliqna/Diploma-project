...
using DechkoWebApp.Core.Services;
using DechkoWebApp.Infrastructure.Data;
using DechkoWebApp.Infrastructure.Domain;
using DechkoWebApp.Infrastructure.Infrastructure;
...
namespace DechkoWebApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ApplicationDbContext>(options => options.UseLazyLoadingProxies().UseSqlServer(
                Configuration.GetConnectionString("DefaultConnection")));
            services.AddDatabaseDeveloperPageExceptionFilter();
